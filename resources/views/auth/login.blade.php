        ...
        <div class="card-body">
            <form method="POST"
                ...
                <div class="form-group mb-3">
                    <input type="text"
                           placeholder="{{ ucfirst(__('common.email')) }}"
                           id="email"
                           class="form-control"
                           name="email"
                           required
                ...
                <div class="form-group mb-3">
                    <input type="password"
                           placeholder="{{ ucfirst(__('common.password')) }}"
                           id="password"
                           class="form-control"
                           name="password"
                           required>
                ...
                <div class="form-group mb-3">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"
                                   name="remember">&nbsp;{{ __('auth.remember') }}
                        </label>
                    </div>
                </div>
                ...
                <div class="d-grid mx-auto">
                    <button type="submit"
                            class="btn btn-primary btn-block">{{ __('auth.loginVerb') }}</button>
                </div>
            </form>
